...
#define _cimg_unserialize_case(Ts1,Ts2,Ts3,Tss) \
    ...
    **/
    #include "module/containers/list_fft_decl.h"

    //@}
  }; // struct CImgList { ...

  #include "module/containers/list_insert_impl.h"
  #include "module/containers/list_fft_impl.h"
  #include "module/containers/list_instance_impl.h"
